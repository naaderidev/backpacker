...
<link rel="stylesheet" href="./assets/components/devider/Devider.css" />
<div id="svgElem" class="d-flex">
    <svg
...
class Devider extends HTMLElement {
  constructor() {
    super();
  ...
  connectedCallback() {
    if (this.getAttribute("svg-orient") == "down") {
      this.shadowRoot.querySelector("#svgElem").classList.add("svg-down");
    } else {
      this.shadowRoot.querySelector("#svgElem").classList.add("svg-up");
    }
  }
